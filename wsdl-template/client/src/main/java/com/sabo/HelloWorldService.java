 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://sabo.com/", wsdlLocation = "http://127.0.0.1:9999/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://sabo.com/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://sabo.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sabo.com/", "HelloWorldPort"), HelloWorld.class, features);
    }

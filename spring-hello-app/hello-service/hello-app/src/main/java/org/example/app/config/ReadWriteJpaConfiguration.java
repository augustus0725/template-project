...
public class ReadWriteJpaConfiguration {
    ...
    // 显示配置一个EntityManagerFactory, SpringBoot程序需要一个名为entityManagerFactory的bean
//    @Bean(name = "entityManagerFactory")
//    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("rwEntityManagerFactory") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
